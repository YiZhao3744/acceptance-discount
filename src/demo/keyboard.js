(function(exports) {
	var KeyBoard = function(input,n,options) {
		...
		var back = '<div id="background" style="position: fixed;z-index:-1001;top: 0;right: 0;bottom: 0;left: 0;font-size:0;">123</div>'
		//nfs-keyboard-header
		...
		btnCancelStr += 'float:left;margin-left:2%;text-align:center;color:#524f4f;';
		...
		inputStr += ' style="padding-right: 2%;width:48%;height:28px;float:left;margin-left:8%;';
		...
		tableStr += '	 			<td style="color:#524f4f;background-color:#D3D9DF;">删除</td></tr>';
		tableStr += '</table>';
		tableStr += '</div>';
		//html的渲染
